...
public class TestDelegate implements JavaDelegate, TaskListener {
    ...
    public void execute(DelegateExecution execution) {
        System.out.println("TestDelegate (JavaDelegate) executed! Instance ID: " + execution.getProcessInstanceId());
        execution.setVariable("delegateExecuted", true);
    }

    @Override
    public void notify(DelegateTask delegateTask) {
        System.out.println("TestDelegate (TaskListener) executed! Task Name: " + delegateTask.getName());
