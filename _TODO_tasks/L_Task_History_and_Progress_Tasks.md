...
- [ ] **DTO Update**: Update `StageDTO` to include `actionTaken` (String). <!-- id: 11 -->
- [ ] **CaseService**: Update `getStages(caseId)` logic. <!-- id: 12 -->
...
- [ ] **Task History API**: Implement `GET /api/runtime/tasks/history` (or similar). <!-- id: 13 -->
...
- [ ] **CaseTimeline Update**: Modify `CaseTimeline.tsx`. <!-- id: 14 -->
...
- [ ] **Task Inbox History**: Modify `TaskInbox.tsx`. <!-- id: 15 -->
